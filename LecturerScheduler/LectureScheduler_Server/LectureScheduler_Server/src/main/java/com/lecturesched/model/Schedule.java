...
public class Schedule {
    ...
    public String checkClash(LocalDate date, String time, String room) {
    ...
    public String checkModuleCap(String module) {
        long distinct = timeSlots.values().stream()
                .map(Lecture::getModule).distinct().count();
        boolean known = timeSlots.values().stream()
    ...
    public void addLecture(LocalDate date, String time, String room, String module) {
        Lecture lec = new Lecture(date, time, room, module);
        timeSlots.put(lec.timeKey(), lec);
        roomSlots.put(lec.roomKey(), module);
    }

    public Lecture removeLecture(LocalDate date, String time) {
    ...
    public String getScheduleAsString() {
        ...
        sorted.sort(Comparator.comparing(Lecture::getDate)
                              .thenComparing(Lecture::getTime));
