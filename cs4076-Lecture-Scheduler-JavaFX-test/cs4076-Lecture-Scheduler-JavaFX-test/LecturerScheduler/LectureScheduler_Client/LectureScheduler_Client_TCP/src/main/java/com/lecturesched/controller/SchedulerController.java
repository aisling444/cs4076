...
public class SchedulerController {
    ...
    private String buildRequest(String action, LocalDate date,
                                String time, String room, String module) {
        ...
        switch (action) {
            ...
            case "REMOVE":
                ...
                return "REMOVE|" + d + "|" + time + "||";

            case "DISPLAY":
                return "DISPLAY||||";

            default:  // "OTHER" — server throws IncorrectActionException
                return "OTHER||||";
        }
    }
