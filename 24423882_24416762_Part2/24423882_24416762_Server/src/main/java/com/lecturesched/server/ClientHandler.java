...
public class ClientHandler implements Runnable {
        ...
        try {
            return switch (action) {
                ...
                default -> throw new IncorrectActionException(
                        ...
                        + "Valid: ADD, REMOVE, DISPLAY, EARLY, STOP.");
            };
        } catch (IncorrectActionException e) {
            System.out.println("[Client " + clientId
                    + "] IncorrectActionException: " + e.getMessage());
    ...
    private String handleEarlyLectures() {
        ...
        List<String> mornSlots = List.of(
                "09:00-10:00", "10:00-11:00", "11:00-12:00", "12:00-13:00");
        List<LocalDate> daysToProcess = new ArrayList<>();
        for (Lecture l : snapshot) {
            if (!mornSlots.contains(l.getTime())
                    && !daysToProcess.contains(l.getDate())) {
        ...
        return updatedSchedule.isEmpty()
                ? prefix + "EMPTY"
                : prefix + updatedSchedule;
    }
}
